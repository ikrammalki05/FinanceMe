...
import 'data_source_screen.dart'; // ← NOUVEAU
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final dsCtrl = context.watch<DataSourceController>();
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ── Source de Données (TP) ──────────────────────────────────────
          _SectionTitle('Source de Données — TP'),

          Card(
            child: Column(
              children: [
                // Indicateur de la source active
                Padding(
                ...
                ListTile(
                  ...
                  title: const Text('Gérer les sources de données'),
                  subtitle: const Text(
                    'Parties 1, 2 et 3 du TP',
